...
from SimPEG import (
    Regularization, Inversion, InvProblem, DataMisfit, Utils, Mesh, Maps, Optimization,
    Tests
)
...
class GlobalEM1DFD(unittest.TestCase):
    ...
    def setUp(self, parallel=True):
        ...
        hz = get_vertical_discretization(frequency, sigma_background=1./10.)
